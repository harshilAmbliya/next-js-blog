        ...
        <div className="container mx-auto mt-4 h-screen">
            <div className="flex justify-between items-center py-3">
                ...
                <div className="form-control relative">
                    <span className='absolute h-5 w-5 top-3 left-3 cursor-pointer'><BiSearchAlt className='h-full w-full' /></span>
                    <Input type="text" placeholder="Search by title" className="input input-bordered w-24 md:w-auto px-10 py-1" value={searchBlog} onChange={handleSerachBlog} />
                </div>
            </div>
